						...
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								...
								<div class = "form-group">
									...
									<option>Select the Course ID</option>
									<?php
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $f_student['firstname']." ".$f_student['middlename']." ".$f_student['lastname']?></td>
							<td><?php echo $f_student['course']?></td>
							<td><?php echo $f_student['course_id']?></td>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.estudent_id').click(function(){
				$student_id = $(this).attr('name');
				$('#edit_query').load('load_student.php?student_id=' + $student_id);
			});
		});
	</script>
</html>