			...
			<div class = "modal fade" id = "add_student" tabindex = "-1" role = "dialog" aria-labelledby = "myModallabel">
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						...
						<form method = "POST" action = "save_faculty_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								
								<div class = "form-group">
									<label>Name:</label>
									<input type = "text" name = "faculty_name" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Email:</label>
									<input type = "text" name = "faculty_email" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Password:</label>
									<input type = "password" name = "faculty_password" required = "required" class = "form-control" />
								</div>
							</div>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						?>
						<tr>
							<td><?php echo $f_faculty['faculty_id']?></td>
							<td><?php echo $f_faculty['faculty_name']?></td>
							<td><?php echo $f_faculty['faculty_email']?></td>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.efaculty_id').click(function(){
				faculty_id = $(this).attr('name');
				$('#edit_query').load('load_edit_faculty.php?faculty_id=' + faculty_id);
			});
		});
	</script>
</html>